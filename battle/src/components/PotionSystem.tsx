...
import { POTION_RARITY_COLORS } from '@/types/game';
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DialogTrigger asChild>
            <Button 
              ...
              variant="ghost" 
              className="w-6 h-6"
              disabled={potions.length >= maxPotionSlots || isLoading || availablePotions.length === 0}
            >
